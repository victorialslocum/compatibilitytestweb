...
// BC: describe what line1 and line2 are => line1, line2
...
function updateScores() {
  ...
  items.sort(function (first, second) {
    // negative number means behind in list
    // positive means ahead
    // runs recursively (or with special algorithm)
...
function updateNextTextNode(nextTextNodeIndex) {
  ...
  nextTextNode.line1 = chooseFunction(inputText, nextTextNodeIndex);
}
...
function updateNextTextNodeButton(nextTextNodeIndex) {
  ...
  nextTextNode.line2 = chooseFunction(inputText, nextTextNodeIndex);
}
...
// ben is english expert
// linguistics hobby
function chooseFunction(input, index) {
...
const textNodes = [
  {
    ...
    line2: "I'm your host, Vicomputoria, programmed into this good code",
    options: [
      {
